function  vecshow( Img, disprange,xmap,ymap,vxmap,vymap,typevec,scl)
...
quiver(xmap(:,:,S),ymap(:,:,S),vxmap1(:,:,S),vymap1(:,:,S),scl,'r');
quiver(xmap(:,:,S),ymap(:,:,S),vxmap2(:,:,S),vymap2(:,:,S),scl,'g');
hold off;
